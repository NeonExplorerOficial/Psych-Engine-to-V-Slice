...
class HXCPP_CLASS_ATTRIBUTES Main_obj : public ::hx::Object
{
	...
	public:
		...
		static void psychToVSlice(::Array< ::String > args);
		static ::Dynamic psychToVSlice_dyn();

		static void vsliceToPsych(::Array< ::String > args);
		static ::Dynamic vsliceToPsych_dyn();

		static ::String awaitInput(::String message);
		static ::Dynamic awaitInput_dyn();

		static void waitAndClose(Float waitTime,int code);
		static ::Dynamic waitAndClose_dyn();

		static void closeWithMessage(::String message,::hx::Null< Float >  waitTime, ::Dynamic code);
		static ::Dynamic closeWithMessage_dyn();
