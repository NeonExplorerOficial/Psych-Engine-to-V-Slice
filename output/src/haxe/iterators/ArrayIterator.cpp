...
HX_DEFINE_STACK_FRAME(_hx_pos_afbbd45afacd6a4a_28_new,"haxe.iterators.ArrayIterator","new",0x70a754c8,"haxe.iterators.ArrayIterator.new","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/haxe/iterators/ArrayIterator.hx",28,0x6c41b97c)
HX_LOCAL_STACK_FRAME(_hx_pos_afbbd45afacd6a4a_45_hasNext,"haxe.iterators.ArrayIterator","hasNext",0x74587dd5,"haxe.iterators.ArrayIterator.hasNext","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/haxe/iterators/ArrayIterator.hx",45,0x6c41b97c)
HX_LOCAL_STACK_FRAME(_hx_pos_afbbd45afacd6a4a_53_next,"haxe.iterators.ArrayIterator","next",0x21c2db8b,"haxe.iterators.ArrayIterator.next","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/haxe/iterators/ArrayIterator.hx",53,0x6c41b97c)
namespace haxe{
namespace iterators{

void ArrayIterator_obj::__construct(::cpp::VirtualArray array){
            	HX_STACKFRAME(&_hx_pos_afbbd45afacd6a4a_28_new)
...
bool ArrayIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_afbbd45afacd6a4a_45_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(ArrayIterator_obj,hasNext,return )
 ...
 ::Dynamic ArrayIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_afbbd45afacd6a4a_53_next)
