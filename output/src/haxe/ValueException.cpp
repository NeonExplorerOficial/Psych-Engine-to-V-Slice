...
HX_DEFINE_STACK_FRAME(_hx_pos_e7799e75465cd974_23_new,"haxe.ValueException","new",0xb19045f8,"haxe.ValueException.new","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/haxe/ValueException.hx",23,0x9b6cdb05)
HX_LOCAL_STACK_FRAME(_hx_pos_e7799e75465cd974_36_unwrap,"haxe.ValueException","unwrap",0xe3875a0b,"haxe.ValueException.unwrap","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/haxe/ValueException.hx",36,0x9b6cdb05)
namespace haxe{

void ValueException_obj::__construct( ::Dynamic value, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_e7799e75465cd974_23_new)
HXDLIN(  23)		{
...
bool ValueException_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic ValueException_obj::unwrap(){
            	HX_STACKFRAME(&_hx_pos_e7799e75465cd974_36_unwrap)
