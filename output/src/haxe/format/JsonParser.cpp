...
HX_DEFINE_STACK_FRAME(_hx_pos_4b1c59a0d999aae0_51_new,"haxe.format.JsonParser","new",0xa017eec8,"haxe.format.JsonParser.new","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/haxe/format/JsonParser.hx",51,0x5d82709a)
HX_LOCAL_STACK_FRAME(_hx_pos_4b1c59a0d999aae0_56_doParse,"haxe.format.JsonParser","doParse",0xa959e310,"haxe.format.JsonParser.doParse","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/haxe/format/JsonParser.hx",56,0x5d82709a)
HX_LOCAL_STACK_FRAME(_hx_pos_4b1c59a0d999aae0_71_parseRec,"haxe.format.JsonParser","parseRec",0xda258b75,"haxe.format.JsonParser.parseRec","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/haxe/format/JsonParser.hx",71,0x5d82709a)
HX_LOCAL_STACK_FRAME(_hx_pos_4b1c59a0d999aae0_152_parseString,"haxe.format.JsonParser","parseString",0x8c919bcc,"haxe.format.JsonParser.parseString","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/haxe/format/JsonParser.hx",152,0x5d82709a)
HX_LOCAL_STACK_FRAME(_hx_pos_4b1c59a0d999aae0_256_parseNumber,"haxe.format.JsonParser","parseNumber",0x1cdbf9c4,"haxe.format.JsonParser.parseNumber","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/haxe/format/JsonParser.hx",256,0x5d82709a)
HX_LOCAL_STACK_FRAME(_hx_pos_4b1c59a0d999aae0_313_nextChar,"haxe.format.JsonParser","nextChar",0xf138ae01,"haxe.format.JsonParser.nextChar","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/haxe/format/JsonParser.hx",313,0x5d82709a)
HX_LOCAL_STACK_FRAME(_hx_pos_4b1c59a0d999aae0_316_invalidChar,"haxe.format.JsonParser","invalidChar",0xa9f373d5,"haxe.format.JsonParser.invalidChar","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/haxe/format/JsonParser.hx",316,0x5d82709a)
HX_LOCAL_STACK_FRAME(_hx_pos_4b1c59a0d999aae0_322_invalidNumber,"haxe.format.JsonParser","invalidNumber",0x8e9d1988,"haxe.format.JsonParser.invalidNumber","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/haxe/format/JsonParser.hx",322,0x5d82709a)
HX_LOCAL_STACK_FRAME(_hx_pos_4b1c59a0d999aae0_45_parse,"haxe.format.JsonParser","parse",0xed2c189b,"haxe.format.JsonParser.parse","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/haxe/format/JsonParser.hx",45,0x5d82709a)
namespace haxe{
namespace format{

void JsonParser_obj::__construct(::String str){
            	HX_STACKFRAME(&_hx_pos_4b1c59a0d999aae0_51_new)
...
bool JsonParser_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic JsonParser_obj::doParse(){
            	HX_STACKFRAME(&_hx_pos_4b1c59a0d999aae0_56_doParse)
...
HX_DEFINE_DYNAMIC_FUNC0(JsonParser_obj,doParse,return )
 ...
 ::Dynamic JsonParser_obj::parseRec(){
            	HX_STACKFRAME(&_hx_pos_4b1c59a0d999aae0_71_parseRec)
...
::String JsonParser_obj::parseString(){
            	HX_GC_STACKFRAME(&_hx_pos_4b1c59a0d999aae0_152_parseString)
...
HX_DEFINE_DYNAMIC_FUNC0(JsonParser_obj,parseString,return )
 ...
 ::Dynamic JsonParser_obj::parseNumber(int c){
            	HX_STACKFRAME(&_hx_pos_4b1c59a0d999aae0_256_parseNumber)
...
int JsonParser_obj::nextChar(){
            	HX_STACKFRAME(&_hx_pos_4b1c59a0d999aae0_313_nextChar)
...
void JsonParser_obj::invalidChar(){
            	HX_STACKFRAME(&_hx_pos_4b1c59a0d999aae0_316_invalidChar)
HXLINE( 317)		this->pos--;
...
void JsonParser_obj::invalidNumber(int start){
            	HX_STACKFRAME(&_hx_pos_4b1c59a0d999aae0_322_invalidNumber)
...
HX_DEFINE_DYNAMIC_FUNC1(JsonParser_obj,invalidNumber,(void))
 ...
 ::Dynamic JsonParser_obj::parse(::String str){
            	HX_GC_STACKFRAME(&_hx_pos_4b1c59a0d999aae0_45_parse)
