...
HX_DEFINE_STACK_FRAME(_hx_pos_0e7ef37ea85e106c_116_new,"haxe.ds._HashMap.HashMapData","new",0x79117a62,"haxe.ds._HashMap.HashMapData.new","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/haxe/ds/HashMap.hx",116,0x726dc3b5)
namespace haxe{
namespace ds{
namespace _HashMap{

void HashMapData_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_0e7ef37ea85e106c_116_new)
