...
HX_LOCAL_STACK_FRAME(_hx_pos_728f98a28fa06cac_44_parse,"haxe.Json","parse",0x396f54d5,"haxe.Json.parse","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/haxe/Json.hx",44,0xe4b4357b)
HX_LOCAL_STACK_FRAME(_hx_pos_728f98a28fa06cac_60_stringify,"haxe.Json","stringify",0x9504336d,"haxe.Json.stringify","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/haxe/Json.hx",60,0xe4b4357b)
namespace haxe{
...
bool Json_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Json_obj::parse(::String text){
            	HX_GC_STACKFRAME(&_hx_pos_728f98a28fa06cac_44_parse)
...
::String Json_obj::stringify( ::Dynamic value, ::Dynamic replacer,::String space){
            	HX_STACKFRAME(&_hx_pos_728f98a28fa06cac_60_stringify)
