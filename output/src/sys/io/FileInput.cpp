...
HX_DEFINE_STACK_FRAME(_hx_pos_233ee9fdd5d0222c_33_new,"sys.io.FileInput","new",0x565591b9,"sys.io.FileInput.new","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",33,0xc3d72326)
HX_LOCAL_STACK_FRAME(_hx_pos_233ee9fdd5d0222c_37_readByte,"sys.io.FileInput","readByte",0x25e0b585,"sys.io.FileInput.readByte","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",37,0xc3d72326)
HX_LOCAL_STACK_FRAME(_hx_pos_233ee9fdd5d0222c_48_readBytes,"sys.io.FileInput","readBytes",0xfebe1f4e,"sys.io.FileInput.readBytes","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",48,0xc3d72326)
HX_LOCAL_STACK_FRAME(_hx_pos_233ee9fdd5d0222c_58_close,"sys.io.FileInput","close",0x735aa151,"sys.io.FileInput.close","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",58,0xc3d72326)
HX_LOCAL_STACK_FRAME(_hx_pos_233ee9fdd5d0222c_64_seek,"sys.io.FileInput","seek",0x37d7f1ff,"sys.io.FileInput.seek","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",64,0xc3d72326)
HX_LOCAL_STACK_FRAME(_hx_pos_233ee9fdd5d0222c_68_tell,"sys.io.FileInput","tell",0x38812eb8,"sys.io.FileInput.tell","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",68,0xc3d72326)
HX_LOCAL_STACK_FRAME(_hx_pos_233ee9fdd5d0222c_72_eof,"sys.io.FileInput","eof",0x564ec615,"sys.io.FileInput.eof","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/cpp/_std/sys/io/FileInput.hx",72,0xc3d72326)
namespace sys{
namespace io{

void FileInput_obj::__construct( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_233ee9fdd5d0222c_33_new)
...
int FileInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_233ee9fdd5d0222c_37_readByte)
HXDLIN(  37)		try {
...
int FileInput_obj::readBytes( ::haxe::io::Bytes s,int p,int l){
            	HX_GC_STACKFRAME(&_hx_pos_233ee9fdd5d0222c_48_readBytes)
HXDLIN(  48)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void FileInput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_233ee9fdd5d0222c_58_close)
...
void FileInput_obj::seek(int p, ::sys::io::FileSeek pos){
            	HX_STACKFRAME(&_hx_pos_233ee9fdd5d0222c_64_seek)
...
int FileInput_obj::tell(){
            	HX_STACKFRAME(&_hx_pos_233ee9fdd5d0222c_68_tell)
...
bool FileInput_obj::eof(){
            	HX_STACKFRAME(&_hx_pos_233ee9fdd5d0222c_72_eof)
