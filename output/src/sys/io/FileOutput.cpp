...
HX_DEFINE_STACK_FRAME(_hx_pos_04cdf744cad0b3d2_33_new,"sys.io.FileOutput","new",0x19e22a16,"sys.io.FileOutput.new","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",33,0x827db3eb)
HX_LOCAL_STACK_FRAME(_hx_pos_04cdf744cad0b3d2_37_writeByte,"sys.io.FileOutput","writeByte",0x887099bd,"sys.io.FileOutput.writeByte","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",37,0x827db3eb)
HX_LOCAL_STACK_FRAME(_hx_pos_04cdf744cad0b3d2_44_writeBytes,"sys.io.FileOutput","writeBytes",0xda15ec16,"sys.io.FileOutput.writeBytes","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",44,0x827db3eb)
HX_LOCAL_STACK_FRAME(_hx_pos_04cdf744cad0b3d2_48_flush,"sys.io.FileOutput","flush",0x5fbc15fa,"sys.io.FileOutput.flush","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",48,0x827db3eb)
HX_LOCAL_STACK_FRAME(_hx_pos_04cdf744cad0b3d2_51_close,"sys.io.FileOutput","close",0xa583caee,"sys.io.FileOutput.close","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",51,0x827db3eb)
HX_LOCAL_STACK_FRAME(_hx_pos_04cdf744cad0b3d2_57_seek,"sys.io.FileOutput","seek",0x8f50ab02,"sys.io.FileOutput.seek","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",57,0x827db3eb)
HX_LOCAL_STACK_FRAME(_hx_pos_04cdf744cad0b3d2_61_tell,"sys.io.FileOutput","tell",0x8ff9e7bb,"sys.io.FileOutput.tell","/nix/store/5jm5dzbx9vz8fl7j3bdqv8mj8b6z3pq4-haxe-4.3.6/lib/haxe/std/cpp/_std/sys/io/FileOutput.hx",61,0x827db3eb)
namespace sys{
namespace io{

void FileOutput_obj::__construct( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_04cdf744cad0b3d2_33_new)
...
void FileOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_04cdf744cad0b3d2_37_writeByte)
HXDLIN(  37)		try {
...
int FileOutput_obj::writeBytes( ::haxe::io::Bytes s,int p,int l){
            	HX_STACKFRAME(&_hx_pos_04cdf744cad0b3d2_44_writeBytes)
HXDLIN(  44)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void FileOutput_obj::flush(){
            	HX_STACKFRAME(&_hx_pos_04cdf744cad0b3d2_48_flush)
HXDLIN(  48)		_hx_std_file_flush(this->_hx___f);
            	}


void FileOutput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_04cdf744cad0b3d2_51_close)
...
void FileOutput_obj::seek(int p, ::sys::io::FileSeek pos){
            	HX_STACKFRAME(&_hx_pos_04cdf744cad0b3d2_57_seek)
...
int FileOutput_obj::tell(){
            	HX_STACKFRAME(&_hx_pos_04cdf744cad0b3d2_61_tell)
